...
class PUZZLE:
    ...
    def __init__(self, reihen, zeilen, nase):
        ###Initialisiert das Puzzle.###
        self.svg = 0 
        self.name = "Puzzle_Version_5.svg"
        self.raster_x = 80
        self.raster_y = 80
        self.zeilen = reihen
        self.reihen = zeilen
...
class FENSTER:
    ...
    def  __init__(self):
        ...
        self.text_reihe = Label(text = "Spalten: ", fg = "green", bg = "black", anchor = "w")
        self.text_zeile = Label(text = "Zeilen: ", fg = "green", bg = "black", anchor = "w")
        self.text_groesse = Label(text = "Puzzlegröße:(1-4)", fg = "green", bg = "black", anchor = "w")
        self.text_reihe.place(x = 40, y = 60, width = 60, height = 20)
        self.text_zeile.place(x = 40, y = 80, width = 60, height = 20)
        self.text_groesse.place(x = 40, y = 100, width = 120, height = 20)
        ...
        self.input_groesse = Entry(self.anzeige, width = 3, bg = "silver", fg = "green")
        self.input_reihe.insert(0, 16)
        self.input_zeile.insert(0, 12)        
        self.input_groesse.insert(0, 3)
        self.input_reihe.place(x = 160, y = 60)
        self.input_zeile.place(x = 160, y = 80)
        self.input_groesse.place(x = 160, y = 100)  
        self.bt_erstellen = Button(self.anzeige, text="Puzzle erstellen", command = puzzle_erstellen)
        self.bt_erstellen.place(x = 100, y = 140, width = 100, height = 20)
        self.bt_beenden = Button(self.anzeige, text="beenden" , width=25, command=root.destroy)
        self.bt_beenden.place(x =100, y = 160, width = 100, height = 20)
        self.text_info = Label(text = "  by \n mini revollo \n  member of the \n erfindergarden", font = "Consolas", fg = "green", bg = "black", anchor = "center")
        self.text_info.place(x = 0, y = 200, width = self.breite, height = 80)
